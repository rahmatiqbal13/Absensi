...
export default async function DashboardPage({
  ...
  // atasan sees ORG-WIDE aggregate counts here (or branch-scoped when a branch is
  // chosen via DashboardControls below), not team-scoped. That is the intended
  // tier for this MVP; team-scoping would need a separate atasan_id-filtered query.
